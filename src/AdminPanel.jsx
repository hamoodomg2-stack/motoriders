      ...
      <AnimatePresence>
        {toast && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -50 }}
            className={`fixed top-4 left-1/2 -translate-x-1/2 z-50 px-6 py-3 rounded-2xl font-bold text-sm shadow-xl ${
          ...
          {[
            ...
            return (
              <motion.button
                ...
                className={`p-3 rounded-2xl border text-center transition-all ${colors[s.color]} ${
                  filter === s.key ? "ring-2 ring-orange-500" : ""
                }`}
              >
